...
echo "<pre>Autoscript Created By Lee Dzung 0146463183</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
lee-connect
wget -O /etc/nginx/conf.d/vps.conf $chuyen$tinh$doi$ta$nhu$anh$thuyen$anh$ben$em$do$em$dua$em$ve$em$suot$em$dau$em$neo/vps.conf
...
lee-connect
wget $chuyen$tinh$doi$ta$nhu$anh$thuyen$anh$ben$em$do$em$dua$em$ve$em$suot$em$dau$em$neo/webmin.sh
chmod +x webmin.sh
./webmin.sh
lee-connect
